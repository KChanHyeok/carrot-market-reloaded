...
import {
  ...
  ChatBubbleOvalLeftEllipsisIcon as SolidChatBubbleLeftIcon,
...
import {
  ...
  ChatBubbleOvalLeftEllipsisIcon as OutlineChatBubbleLeftIcon,
  ...
  return (
    <div className="fixed bottom-0 w-full mx-auto max-w-screen-md grid grid-cols-5 border-neutral-600 border-t px-5 py-3 *:text-white bg-neutral-800">
      ...
      <Link href="/chat" className="flex flex-col items-center gap-px">
        {pathname === "/chat" ? (
          <SolidChatBubbleLeftIcon className="w-7 h-7" />
        ) : (
          <OutlineChatBubbleLeftIcon className="w-7 h-7" />
        )}
        <span>채팅</span>
      </Link>
